...
const addToCart = async () => {
  const res = await cartStore.addGoods(data.goods.id, data.qty, data.selectedSpec)
...
const reserveInit = () => {
  data.form = { userId: user.value.id, goodsId: data.goods.id, num: data.qty, spec: data.selectedSpec }
